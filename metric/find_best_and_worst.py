...
metric_name_list = ['CC', 'SIM', 'AUC_JUD', 'AUC_BOR', 'SAUC', 'EMD', 'KLD', 'NSS']
...
# print "The best",str(examples),metric_name_list[metric_index], "index:",sorted_indexes[:examples]
print "The worst",str(examples),metric_name_list[metric_index], "index:",sorted_indexes[-examples:]
