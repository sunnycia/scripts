...
'kld':6,
'nss':7}
def metric_plot_video(metric_dir, output_dir, temp_file_dir, metric_name, index_list, mat_wildcard='videoSRC%s*.mat', video_length=5, resolution=(1920,1080)):
    ...
    for index in index_list:
        ...
        for i in range(nframe):
            ...
            plt.plot(x,y, 'blue', linewidth=7.0)
